...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-studyplanner-secret-key-change-in-production')
...
# ✅ SQLite — works on Render free tier without any extra setup
DATABASES = {
    'default': {
